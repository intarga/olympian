            ...
            range_check_wind_direction_cache(&DataCache::new(
                vec![
                    Timeseries {
                        ...
                        values: vec![Some(0.), Some(120.), Some(390.)]
                    },
                    Timeseries {
                        tag: "blindern2".to_string(),
                        values: vec![Some(0.), Some(390.), None]
                    },
                    Timeseries {
                        tag: "blindern3".to_string(),
                        values: vec![Some(0.), Some(-5.), Some(1.)]
                    },
                    Timeseries {
                        tag: "blindern4".to_string(),
                        values: vec![Some(390.), None, Some(1.)]
                    },
                ],
                vec![0., 1., 2., 3.],
                vec![0., 1., 2., 3.],
