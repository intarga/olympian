...
/// Consistency check that fails if the first element is over a limit, while the second is a
/// special value.
///
/// typically used to compare visibility with cloud area fraction
pub fn upper_limit_special_value_pair(
    data1: &SeriesCache,
    limit: f32,
    data2: &SeriesCache,
    special_value: f32,
